...
<body>
<!-- Affichage de tous les utilisateurs sinon renvoie autre -->
<div class="container mt-5">
    <h1>Résultats de recherche pour "{{ "" }}"</h1>
    ...
    @else
        <table class="table">
            ...
            <tbody>
            <!-- Création de tableau avec les données de l'utilisateur -->
            @foreach($utilisateurs as $utilisateur)
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modifierUtilisateurModal{{ $utilisateur->id }}">
                            Modifier
                        </button>
